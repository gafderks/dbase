...
def param_replace(context, **kwargs):
    ...
    Setting a parameter None removes it from the query string.
    ...
    # Remove variables for which the value is None
    for key in [key for key, value in get_variable_dict.items() if value is None]:
